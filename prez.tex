...
\title{Využitie umelej inteligencie pre zachytenie pohybu v hrách
}
...
\includegraphics[scale=.35]{graf.pdf}
...
\begin{frame}[fragile=singleslide]\frametitle{\dots}
\begin{itemize}
\item Odrážka1
\item 2
	\begin{itemize}
